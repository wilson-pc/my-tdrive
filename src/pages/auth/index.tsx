...
export default function LoginPage() {
  ...
  const handleCodeSubmit = async (e: any) => {
    try {
      ...
      if (err.errorFields) {
        ...
        setError('Error al iniciar sesión. Verifica el código ingresado o tu número.');
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className='login-page-container' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', background: '#f0f2f5' }}>
    <Card
      style={{ width: 400, padding: '20px', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}
      hoverable
    >
      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
        <Avatar size={64} icon={<UserOutlined />} style={{ backgroundColor: '#1890ff', marginBottom: '16px' }} />
        <Title level={3} style={{ margin: 0 }}>Telegram Login</Title>
        ...
        >
          <Form.Item
            ...
            rules={[
              ...
              { pattern: /^\d+$/, message: 'El número debe contener solo dígitos.' }
            ]}
          ...
          >
            <Space.Compact style={{ width: '100%' }}>
              <Form.Item
                ...
                rules={[{ required: true, message: 'Código de país requerido' }]}
              >
                <Select
                  style={{ width: 200 }}
                  showSearch
        ...
        >
          <Form.Item
            ...
            rules={[
              ...
              { pattern: /^\d+$/, message: 'El código debe contener solo números.' }
            ]}
          >
